...
const Editor = ({ rerender ,handleFetch,handleRecord,handleStop}: { rerender: any, handleFetch:any , handleRecord:()=>void,handleStop:()=>void } ) => {
  ...
  return (
    <div> 
      ...
      <TaskBar handleFetch={handleFetch} handleRecord={handleRecord} handleStop={handleStop}/>
    </div>
  );
};
